...
const UnblockTimeModal = () => {
    return (
            <>
            <div className="modal right fade modal-sidebar view-event-modal" id="un-block-time-modal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h2 className="modal-heading">Unblock Time</h2>
                                    ...
                                    <div className="col-sm-12 col-md-12 col-lg-12 form-group">
                                        <div className="add-input-bx">
                                            ...
                                            <ul className="ul-row">
                                                ...
                                                <li><button className="btn default-btn">Unblock</button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
